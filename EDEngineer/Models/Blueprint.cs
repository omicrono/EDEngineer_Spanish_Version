    ...
    public class Blueprint : INotifyPropertyChanged
    {
        ...
        public bool JustMissingCommodities
            => CanCraftCount == 0 &&
                Ingredients.All(
                    i =>
                        i.Size <= i.Entry.Count && i.Entry.Data.Kind != Kind.Mercancias || // not commodity and just enough or more stock available
                        i.Size > i.Entry.Count && i.Entry.Data.Kind == Kind.Mercancias); // commodity and not enough stock
