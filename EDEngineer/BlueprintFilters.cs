...
namespace EDEngineer
{
    public class BlueprintFilters : INotifyPropertyChanged
    {
        ...
        public BlueprintFilters(IReadOnlyCollection<Blueprint> availableBlueprints)
        {
            ...
            {
                new IgnoredFavoriteFilter("Ninguno", blueprint => !blueprint.Ignored && !blueprint.Favorite, "IFFnone")
                {
                    Checked = true,
                },
                new IgnoredFavoriteFilter("Favorito", blueprint => blueprint.Favorite, "IFFfavorite")
                {
                    Checked = true,
                },
                new IgnoredFavoriteFilter("Ignorado", blueprint => blueprint.Ignored, "IFFignored")
                {
                    Checked = false,
                }
            };
            ...
            {
                new CraftableFilter("Elaborable", blueprint => blueprint.CanCraftCount >= 1, "CFcraftable")
                {
                    Checked = true
                },
                new CraftableFilter("No Elaborable", blueprint => blueprint.CanCraftCount == 0, "CFnoncraftable")
                {
                    Checked = true
                },
                new CraftableFilter("Mercancías desaparecidas", blueprint => blueprint.JustMissingCommodities, "CFmissingcommodities")
                {
                    Checked = true
                }
            };
